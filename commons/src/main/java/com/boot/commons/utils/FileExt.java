...
public enum FileExt {
	jpg(MimeType.IMG), gif(MimeType.IMG), jpeg(MimeType.IMG), png(MimeType.IMG), bmp(MimeType.IMG), 
	swf(MimeType.FLASH), flv(MimeType.FLASH), 
	pdf(MimeType.PDF), 
	html(MimeType.HTML),
	txt(MimeType.TXT), csv(MimeType.TXT),doc(MimeType.TXT), log(MimeType.TXT),
	docx(MimeType.TXT), xls(MimeType.TXT), xlsx(MimeType.TXT),xml(MimeType.TXT), 
	orc(MimeType.TXT), nct(MimeType.TXT), dsb(MimeType.TXT), mht(MimeType.TXT), 
	msg(MimeType.TXT), 
	zip(MimeType.FILE);
