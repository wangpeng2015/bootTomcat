...
public interface Mp4Mapper extends CommonMapper<Log,Integer> {
    ...
    Map<String, String> findMp4OrderInfo(@Param("tradeOrder") String tradeOrder, @Param("status") Integer status);
    ...
    Integer saveuploadImg(@Param("fileContentType") String fileContentType, @Param("fileName") String fileName);

    List<Map<String,String>> getPicture(@Param("pageStart") Integer pageStart, @Param("pageSize") Integer pageSize);
